...
**Prerequisites:** [.NET 10 SDK](https://dotnet.microsoft.com/download) (`net10.0`). References `Novolis.Cad.Primitives`, `Novolis.ThreeD.Scene`, `Novolis.Math.Geometry`.
...
| [`Novolis.ThreeD.Scene`](https://github.com/Novolis-Platform/novolis-3d/tree/main/src/Novolis.ThreeD.Scene) | Output `SceneDocument` / `.nov3djson` |
